...
var file_memo_v1_notes_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x65, 0x72, 0x72, 0x4d, 0x73, 0x67, 0x32, 0xd9, 0x01, 0x0a, 0x0b,
...
var file_memo_v1_notes_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_memo_v1_notes_proto_depIdxs = []int32{
	...
	3, // 3: memo.v1.NoteService.GetNote:output_type -> memo.v1.GetNoteResponse
	1, // 4: memo.v1.NoteService.CreateNote:output_type -> memo.v1.CreateNoteResponse
	5, // 5: memo.v1.NoteService.RemoveNote:output_type -> memo.v1.DeleteNoteResponse
...
func file_memo_v1_notes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_memo_v1_notes_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
